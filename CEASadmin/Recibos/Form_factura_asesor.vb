Public Class Form_factura_asesor

    Private Sub Form_factura_asesor_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.PictureBox3.Image = imagenlogocea
        ...
        Me.Label2.Text = imp_fecha
        Me.Label17.Text = imp_asesor_doc
        Me.Label16.Text = imp_asesor_nom
        Me.Label18.Text = imp_asesor_cel
        Me.Label19.Text = imp_asesor_dir
        Me.Label22.Text = imp_concepto
        Me.Label33.Text = imp_concepto2

        Me.Label23.Text = imp_valor.ToString("###,###,##0")
        Me.Label27.Text = imp_valor.ToString("###,###,##0")
        Me.Label32.Text = "Alumno:" & imp_clientenom
        Me.Label44.Text = "Doc: " & imp_clientedoc
        Me.Label34.Text = "Dir: " & imp_clientedir
        Me.Label35.Text = "Tel: " & imp_clientetel

        If imp_prefijo_prioridad = "SI" Then Label36.Visible = True
        If imp_prefijo_prioridad <> "SI" Then Label36.Visible = False

        Me.Label31.Text = "Elaboró: " & usrnom
        Me.Label41.Text = "Forma de Pago: " & imp_mediopago
