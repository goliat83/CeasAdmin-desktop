...
Public Class Form_factura_ingreso

  
    Private Sub Form_factura_ingreso_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Me.Label17.Text = imp_clientedoc
        Me.Label16.Text = imp_clientenom
        Me.Label18.Text = imp_clientetel
        Me.Label19.Text = imp_clientedir
        Me.Label22.Text = imp_concepto & " - " & imp_concepto2
        Me.Label23.Text = imp_valor.ToString("###,###,##0")
        Me.Label27.Text = imp_valor.ToString("###,###,##0")
        ' Me.Label32.Text = imp_concepto2
